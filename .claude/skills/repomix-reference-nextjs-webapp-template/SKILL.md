---
name: repomix-reference-nextjs-webapp-template
description: Reference codebase for Nextjs Webapp Template. Use this skill when you need to understand the structure, implementation patterns, or code details of the Nextjs Webapp Template project.
---

# Nextjs Webapp Template Codebase Reference

125 files | 6704 lines | 49910 tokens
